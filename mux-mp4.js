...
var Cea608Stream = function(field, dataChannel) {
  ...
  this.push = function(packet) {
    ...
    // Append extended characters to caption text
      ...
      // IE if a "猫" is desired, you'll always receive "e猫"; non-compliant
      // decoders are supposed to drop the "猫", while compliant decoders
      // backspace the "e" and insert "猫".
...
module.exports = {
  ...
  setDuration: function(duration) {
    if (duration) {
      customDuration = duration * 90000; // 涔樹互 timescale
    }
  },
